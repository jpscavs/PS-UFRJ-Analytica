...
# Desempenho acadêmico das escolas municipais vs estaduais na educação fundamental
...
# Desempenho acadêmico das escolas privadas vs públicas na educação fundamental
...
# Taxa de aprovação nas escolas municipais vs estaduais na educação do ensino médio
...
# Taxa de aprovação nas escolas privadas vs publicas na educação do ensino médio
